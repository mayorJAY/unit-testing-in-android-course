...
public class QuestionDetailsFragment extends BaseFragment{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FetchQuestionDetailsUseCase mFetchQuestionDetailsUseCase = getCompositionRoot().getFetchQuestionDetailsUseCase();
        ToastsHelper mToastsHelper = getCompositionRoot().getToastsHelper();
        ScreensNavigator mScreensNavigator = getCompositionRoot().getScreensNavigator();
        mQuestionDetailsController = new QuestionDetailsController(mFetchQuestionDetailsUseCase, mScreensNavigator, mToastsHelper);
    }
